...
(function() {
  var Fairy, Queue, enter_exiting_mode, exiting, fairy_id, os, prefix, queue_names, redis, registered, server_ip, uuid,
  ...
  Queue = (function() {
    ...
    Queue.prototype.regist = function(handler) {
      ...
      registered.push("" + this.fairy.id + "|" + this.name);
      worker_id = uuid.v4();
      this.redis.hset(this.key('WORKERS'), worker_id, "" + (os.hostname()) + "|" + (server_ip()) + "|" + process.pid);
